class Appointment:
    ...
    def __str__(self):
        return f"{self.__client_name:20s},{self.__client_phone:15s},{self.__day_of_week:10s},{Appointment.get_end_time_hour():10s},{Appointment.get_appt_type_desc():20s}"
